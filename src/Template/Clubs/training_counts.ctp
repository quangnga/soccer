...
<p style="text-align: center; font-style: italic; color: #777"> <strong>تاريخ التعديل : </strong> <?php echo $date_cv?></p>
                                ...
                                <div class="row" style="text-align: center; margin-bottom: 10px;">
                                        ...
                                        <button class="btn btn-danger" onclick="savepdf(<?php echo $id_club?>)" onload="get_time()" type="submit">Reset Counts  </button>
...
<script>
    ...
    function savepdf(id){
        if(confirm('Do you want reset count ?')){
            var url = '<?php echo $this->Url->build(["controller" => "Clubs", "action" => "pdftraining",]) ?>'+'/'+id;
