...
<div class="portlet portlet-default">
    <div class="portlet-heading">
        <div class="portlet-title">
            <h4><strong> <?= h($region->name) ?></strong> Edit Form</h4>
        </div>
        ...
        <fieldset>
            ...
            <div class="form-group col-md-12">
                ...
                <div class="form-group">
                    ...
                    <?php echo $this->Form->input('name', array('class' => 'form-control', 'placeholder' => 'Enter region name', 'maxlength' => '20', 'label' => ' Name *')); ?>
                </div>
            </div>
            <div class="form-group col-md-12">
                <div class="form-group">
