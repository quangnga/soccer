...
<head>
    ...
    <title>Katsnap Head shots</title>

    <!-- Core Meta Data -->
	<meta name="author" content="Technical Knockouts">
	<meta name="description" content="Katsnap Photography">
	<meta name="keywords" content="katsnap, photography, photoshoot, headshots, photos">
...
<!-- Navigation -->
<nav class="push-nav push-right" style="background-image: url('<?php echo $this->request->webroot; ?>images/headshots/<?= h($gallery->first()->headshots_navbar)?>');">
    <!-- Logo -->
...
<div id="wrap">
    ...
    <!-- Hero -->
    <section class="poster dark center padded-xl nav-trigger" style="background-image: url('<?php echo $this->request->webroot; ?>images/headshots/<?= h($gallery->first()->headshots_header)?>')" data-0="background-position: 0px 0px;" data-top-bottom="background-position: 0px 100px">
        ...
        <div class="container">
            <div class="col-xs-12 col-sm-10 col-sm-offset-1" data-0="opacity: 1;" data-top-bottom="opacity: 0;">
                ...
                <h5><?= h($gallery->first()->headshots_header_description) ?></h5>
                <div class="row">
				<div class="col-xs-12 wow fadeInUp call-to-action" data-wow-delay="0.8s">
					<a href="#section5" class="button">Headshots Gallery</a>
				</div>
			</div>
            </div>
        </div>
    ...
    <section id="section2" class="container center padded" style="padding-bottom:0px;padding-top:0px;">
        ...
        <div class="row wow fadeIn" data-wow-delay="1.0s">
            <div class="col-xs-12 col-sm-10 col-sm-offset-1">
                <h4>PHOTO SHOOTS</h4>
                <p class="sub-heading"> <?= h($gallery->first()->headshot_text)?><p>
            </div>
        </div>
        ...
        <row class="col-lg-10 col-lg-offset-1">
            <ul align="center" class="sub-heading" style="font-size:21px;">
                <?php foreach(preg_split("/((\r?\n)|(\r\n?))/",$gallery->first()->headshot_points) as $point):?>
...
<h4 class="wow fadeInUp">Headshots Gallery</h4>
        <span class="separator-small"></span>
        <div class="thumbnails dark">
            <div class="thumbnail childcare">
                <div class="overlay"></div>
                <div class="project-info">
                    <div class="picInfo"><?=h($gallery->first()->headshot_tag_1) ?></div>
                </div>
                <img src="<?php echo $this->request->webroot; ?>images/headshots/<?= h($gallery->first()->headshot_1) ?>" class="img-responsive" alt="">
            </div>
            <div class="thumbnail childcare">
                <div class="overlay"></div>
                <div class="project-info">
                    <div class="picInfo"><?=h($gallery->first()->headshot_tag_2) ?></div>
                </div>
                <img src="<?php echo $this->request->webroot; ?>images/headshots/<?= h($gallery->first()->headshot_2) ?>" class="img-responsive" alt="">
            </div>
            <div class="thumbnail portfolio">
                <div class="overlay"></div>
                <div class="project-info">
                    <div class="picInfo"><?=h($gallery->first()->headshot_tag_3) ?></div>
                </div>
                <img src="<?php echo $this->request->webroot; ?>images/headshots/<?= h($gallery->first()->headshot_3) ?>" class="img-responsive" alt="">
            </div>
            <div class="thumbnail kidsgrownups">
                <div class="overlay"></div>
                <div class="project-info">
                    <div class="picInfo"><?=h($gallery->first()->headshot_tag_4) ?></div>
                </div>
                <img src="<?php echo $this->request->webroot; ?>images/headshots/<?= h($gallery->first()->headshot_4) ?>" class="img-responsive" alt="">
            </div>
            <div class="thumbnail headshots">
                <div class="overlay"></div>
                <div class="project-info">
                    <div class="picInfo"><?=h($gallery->first()->headshot_tag_5) ?></div>
                </div>
                <img src="<?php echo $this->request->webroot; ?>images/headshots/<?= h($gallery->first()->headshot_5) ?>" class="img-responsive" alt="">
            </div>
            <div class="thumbnail commercial">
                <div class="overlay"></div>
                <div class="project-info">
                    <div class="picInfo"><?=h($gallery->first()->headshot_tag_6) ?></div>
                </div>
                <img src="<?php echo $this->request->webroot; ?>images/headshots/<?= h($gallery->first()->headshot_6) ?>" class="img-responsive" alt="">
            </div>
            <div class="thumbnail commercial">
                <div class="overlay"></div>
                <div class="project-info">
                    <div class="picInfo"><?=h($gallery->first()->headshot_tag_7) ?></div>
                </div>
                <img src="<?php echo $this->request->webroot; ?>images/headshots/<?= h($gallery->first()->headshot_7) ?>" class="img-responsive" alt="">
            </div>
            <div class="thumbnail commercial">
                <div class="overlay"></div>
                <div class="project-info">
                    <div class="picInfo"><?=h($gallery->first()->headshot_tag_8) ?></div>
                </div>
                <img src="<?php echo $this->request->webroot; ?>images/headshots/<?= h($gallery->first()->headshot_8) ?>" class="img-responsive" alt="">
            </div>
            <div class="thumbnail commercial">
                <div class="overlay"></div>
                <div class="project-info">
                    <div class="picInfo"><?=h($gallery->first()->headshot_tag_9) ?></div>
                </div>
                <img src="<?php echo $this->request->webroot; ?>images/headshots/<?= h($gallery->first()->headshot_9) ?>" class="img-responsive" alt="">
            </div>
        </div><!-- END Thumbnails -->
