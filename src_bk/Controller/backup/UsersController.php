...
class UsersController extends AppController
{
    ...
    public function isAuthorized($user){
        if(in_array($this->request->action, ['View','add','edit','delete','Edit','view','Delete','add_permissions','index'])){
    ...
    public function add()
    {
        ...
        if ($this->request->is('post')) {
            ...
            if ($this->Users->save($user)) {
                ...
                return $this->default_permissions($user->id);
            } else {
    ...
    public function default_permissions($id=null){
     ...
     public function add_permissions($id = null){
      ...
      public function resetPassword() {
        if ($this->request->is('post')) {
            $anUser = $this->Users
                    ...
                    ->first();
            if(empty($anUser)){
                $this->Flash->success(__('If you have entered a valid email then we have sent you an email with a link to reset your password. '));
                ...
                $email->subject('Katsnap Website New Password');
