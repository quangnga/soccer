...
<!-- Navigation -->
<nav class="push-nav push-right" style="background-image: url(<?php echo $this->request->webroot; ?>img/gallery/Preview/<?=h($gallery->first()->kids_grownups_navbar) ?>);">
    <!-- Logo -->
...
<div id="wrap">
    ...
    <!-- Hero -->
    <section class="poster dark center padded-xl nav-trigger" style="background-image: url('<?php echo $this->request->webroot; ?>img/gallery/Preview/<?=h($gallery->first()->kids_grownups_header) ?>');" data-0="background-position: 0px 0px;" data-top-bottom="background-position: 0px 100px">
...
<h4 class="wow fadeInUp">Kids &amp; Grown Ups</h4>
        ...
        <div class="thumbnails dark">
            <div class="thumbnail childcare">
                ...
                <?php echo $this->Html->image('gallery/Preview/'.$gallery->first()->kids_grownups_1,['class'=>'img-responsive','alt'=>''])?>
            </div>
            <div class="thumbnail childcare">
                <div class="overlay"></div>
                <div class="project-info">
                ...
                <?php echo $this->Html->image('gallery/Preview/'.$gallery->first()->kids_grownups_2,['class'=>'img-responsive','alt'=>''])?>
                </div>
            <div class="thumbnail portfolio">
                ...
                <?php echo $this->Html->image('gallery/Preview/'.$gallery->first()->kids_grownups_3,['class'=>'img-responsive','alt'=>''])?>
                </div>
            <div class="thumbnail kidsgrownups">
                ...
                <?php echo $this->Html->image('gallery/Preview/'.$gallery->first()->kids_grownups_4,['class'=>'img-responsive','alt'=>''])?>
                </div>
            <div class="thumbnail headshots">
                ...
                <?php echo $this->Html->image('gallery/Preview/'.$gallery->first()->kids_grownups_5,['class'=>'img-responsive','alt'=>''])?>
                </div>
            <div class="thumbnail commercial">
                ...
                <?php echo $this->Html->image('gallery/Preview/'.$gallery->first()->kids_grownups_6,['class'=>'img-responsive','alt'=>''])?>
                </div>
            <div class="thumbnail commercial">
                <div class="overlay"></div>
                <div class="project-info">
                ...
                <?php echo $this->Html->image('gallery/Preview/'.$gallery->first()->kids_grownups_7,['class'=>'img-responsive','alt'=>''])?>
                </div>
            <div class="thumbnail commercial">
                <div class="overlay"></div>
                <div class="project-info">
                ...
                <?php echo $this->Html->image('gallery/Preview/'.$gallery->first()->kids_grownups_8,['class'=>'img-responsive','alt'=>''])?>
                </div>
            <div class="thumbnail commercial">
                <div class="overlay"></div>
                <div class="project-info">
                ...
                <?php echo $this->Html->image('gallery/Preview/'.$gallery->first()->kids_grownups_9,['class'=>'img-responsive','alt'=>''])?>
                </div>
        </div><!-- END Thumbnails -->
