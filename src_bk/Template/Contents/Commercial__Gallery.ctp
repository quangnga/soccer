...
<!-- Navigation -->
<nav class="push-nav push-right" style="background-image: url('<?php echo $this->request->webroot; ?>images/commercial/<?= h($gallery->first()->commercial_navbar)?>');">
    <!-- Logo -->
...
<div id="wrap">
    ...
    <!-- Hero -->
    <section class="poster dark center padded-xl nav-trigger" style="background-image: url('<?php echo $this->request->webroot; ?>images/commercial/<?= h($gallery->first()->commercial_header)?>');" data-0="background-position: 0px 0px;" data-top-bottom="background-position: 0px 100px">
        ...
        <div class="thumbnails dark">
            <div class="thumbnails dark">
                <div class="thumbnail childcare">
                    ...
                    <img src="<?php echo $this->request->webroot; ?>images/commercial/<?=  h($gallery->first()->commercial_1) ?>" class="img-responsive" alt="">
                </div>
                <div class="thumbnail childcare">
                    <div class="overlay"></div>
                    <div class="project-info">
                    ...
                    <img src="<?php echo $this->request->webroot; ?>images/commercial/<?=   h($gallery->first()->commercial_2) ?>" class="img-responsive" alt="">
                </div>
                <div class="thumbnail portfolio">
                    ...
                    <img src="<?php echo $this->request->webroot; ?>images/commercial/<?=  h($gallery->first()->commercial_3) ?>" class="img-responsive" alt="">
                </div>
                <div class="thumbnail kidsgrownups">
                    ...
                    <img src="<?php echo $this->request->webroot; ?>images/commercial/<?=  h($gallery->first()->commercial_4) ?>" class="img-responsive" alt="">
                </div>
                <div class="thumbnail headshots">
                    ...
                    <img src="<?php echo $this->request->webroot; ?>images/commercial/<?=  h($gallery->first()->commercial_5) ?>" class="img-responsive" alt="">
                </div>
                <div class="thumbnail commercial">
                    ...
                    <img src="<?php echo $this->request->webroot; ?>images/commercial/<?=  h($gallery->first()->commercial_6) ?>" class="img-responsive" alt="">
                </div>
                <div class="thumbnail commercial">
                    <div class="overlay"></div>
                    <div class="project-info">
                    ...
                    <img src="<?php echo $this->request->webroot; ?>images/commercial/<?=  h($gallery->first()->commercial_7) ?>" class="img-responsive" alt="">
                </div>
                <div class="thumbnail commercial">
                    <div class="overlay"></div>
                    <div class="project-info">
                    ...
                    <img src="<?php echo $this->request->webroot; ?>images/commercial/<?=  h($gallery->first()->commercial_8) ?>" class="img-responsive" alt="">
                </div>
                <div class="thumbnail commercial">
                    <div class="overlay"></div>
                    <div class="project-info">
                    ...
                    <img src="<?php echo $this->request->webroot; ?>images/commercial/<?=  h($gallery->first()->commercial_9) ?>" class="img-responsive" alt="">
                </div>
        </div><!-- END Thumbnails -->
