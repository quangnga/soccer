...
<head>
	...
	<meta name="keywords" content="katsnap, photography, childcare, photoshoot, photos">
...
<!-- Navigation -->
<nav class="push-nav push-right" style="background-image: url('<?php echo $this->request->webroot; ?>img/gallery/Preview/<?=h($gallery->first()->childcare_navbar) ?>');">
    <!-- Logo -->
...
<div id="wrap">
    ...
    <!-- Hero -->
    <section class="poster dark center padded-xl nav-trigger" style="background-image: url('<?php echo $this->request->webroot; ?>img/gallery/Preview/<?=h($gallery->first()->childcare_header) ?>');" data-0="background-position: 0px 0px;" data-top-bottom="background-position: 0px 100px">
        ...
        <div class="container">
            <div class="col-xs-12 col-sm-10 col-sm-offset-1" data-0="opacity: 1;" data-top-bottom="opacity: 0;">
				...
				<div class="col-xs-12 wow fadeInUp call-to-action" data-wow-delay="0.8s">
					<a href="#section5" class="button">Childcare Gallery</a>
				</div>
			</div>
            </div>
        </div>
    ...
    <section id="section2" class="container center padded" style="padding-bottom:0px;padding-top:0px;">
        ...
        <div class="row">
            ...
            <!-- 2 -->
                 ...
                 <i class="fa fa-home fa-fw fa-3x" style="margin-right:-17px;"></i><i class="fa fa-child fa-fw fa-2x" style="padding:5px;margin-bottom:24px;"></i>
                <span class="separator-small"></span>
                <h5>Kindergarten</h5>
            </div>
            ...
            <div class="feature-box col-sm-3 wow fadeInUp" data-wow-delay="1.1s">
                <i class="fa fa-building fa-fw fa-3x" style="margin-right:-17px;"></i><i class="fa fa-child fa-fw fa-3x" style="padding:5px;margin-bottom:15px;"></i>
                <span class="separator-small"></span>
                <h5>School</h5>
        ...
        <div class="thumbnails dark">
            <div class="thumbnail childcare">
                ...
                <div class="project-info">
                    <div class="picInfo"><?=h($gallery->first()->childcare_tag_1) ?></div>
                </div>
                <?php echo $this->Html->image('gallery/Preview/'.$gallery->first()->childcare_1,['class'=>'img-responsive','alt'=>''])?>
            </div>
            <div class="thumbnail childcare">
                <div class="overlay"></div>
                <div class="project-info">
                    <div class="picInfo"><?=h($gallery->first()->childcare_tag_2) ?></div>
                </div>
                <?php echo $this->Html->image('gallery/Preview/'.$gallery->first()->childcare_2,['class'=>'img-responsive','alt'=>''])?>
            </div>
            <div class="thumbnail portfolio">
                <div class="overlay"></div>
                <div class="project-info">
                    <div class="picInfo"><?=h($gallery->first()->childcare_tag_3) ?></div>
                </div>
                <?php echo $this->Html->image('gallery/Preview/'.$gallery->first()->childcare_3,['class'=>'img-responsive','alt'=>''])?>
            </div>
            <div class="thumbnail kidsgrownups">
                <div class="overlay"></div>
                <div class="project-info">
                    <div class="picInfo"><?=h($gallery->first()->childcare_tag_4) ?></div>
                </div>
                <?php echo $this->Html->image('gallery/Preview/'.$gallery->first()->childcare_4,['class'=>'img-responsive','alt'=>''])?>
            </div>
            <div class="thumbnail headshots">
                <div class="overlay"></div>
                <div class="project-info">
                    <div class="picInfo"><?=h($gallery->first()->childcare_tag_5) ?></div>
                </div>
                <?php echo $this->Html->image('gallery/Preview/'.$gallery->first()->childcare_5,['class'=>'img-responsive','alt'=>''])?>
            </div>
            <div class="thumbnail commercial">
                <div class="overlay"></div>
                <div class="project-info">
                    <div class="picInfo"><?=h($gallery->first()->childcare_tag_6) ?></div>
                </div>
                <?php echo $this->Html->image('gallery/Preview/'.$gallery->first()->childcare_6,['class'=>'img-responsive','alt'=>''])?>
            </div>
            <div class="thumbnail commercial">
                <div class="overlay"></div>
                <div class="project-info">
                    <div class="picInfo"><?=h($gallery->first()->childcare_tag_7) ?></div>
                </div>
                <?php echo $this->Html->image('gallery/Preview/'.$gallery->first()->childcare_7,['class'=>'img-responsive','alt'=>''])?>
            </div>
            <div class="thumbnail commercial">
                <div class="overlay"></div>
                <div class="project-info">
                    <div class="picInfo"><?=h($gallery->first()->childcare_tag_8) ?></div>
                </div>
                <?php echo $this->Html->image('gallery/Preview/'.$gallery->first()->childcare_8,['class'=>'img-responsive','alt'=>''])?>
            </div>
            <div class="thumbnail commercial">
                <div class="overlay"></div>
                <div class="project-info">
                    <div class="picInfo"><?=h($gallery->first()->childcare_tag_9) ?></div>
                </div>
                <?php echo $this->Html->image('gallery/Preview/'.$gallery->first()->childcare_9,['class'=>'img-responsive','alt'=>''])?>
            </div>
        </div><!-- END Thumbnails -->
